...
st.warning(
    "* **Falta de Variables Temporales:** No poseemos datos secuenciales sobre la evolución mensual histórica para detectar tendencias de abandono.\n"
...
st.info(
    "1. **Modelos de Clustering Avanzado:** Aplicar algoritmos no supervisados como *K-Means* o *DBSCAN* sobre las coordenadas obtenidas en el PCA para identificar grupos de consumidores.\n"
    ...
    "3. **Inclusión de Variables de Negocio:** Integrar los costos operativos de soporte técnico para calcular el valor de vida del cliente."
)